...
const rawstrUSB = require('./scratchserver_usb.py?raw');
const rawstrWLAN = require('./scratchserver_wlan.py?raw');
    ...
    async connect(){
        ...
        return connect = new Promise ((resolve, reject) =>{
            ...
            swal(translate._getText('connectwlan',this.locale), { //lets the user choose between wlan and usb
                ...
                let scratchserver = new File ([rawstr], "/scratchserver.py")
